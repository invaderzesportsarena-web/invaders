...
-- We'll use the existing profiles table instead for user information
...
-- Remove any remaining SECURITY DEFINER views
-- Check if there are any other problematic views and convert them to regular views
CREATE OR REPLACE VIEW public.zcred_balances AS
