...
ALTER TYPE zt_type ADD VALUE 'withdrawal_hold';
ALTER TYPE zt_type ADD VALUE 'withdrawal_refund';

-- Update the withdrawal submission function to use correct enum values
...
BEGIN
  ...
  -- Create transaction record for the deduction using correct enum value
...
-- Update the withdrawal rejection function to use correct enum values
...
BEGIN
  ...
  -- Create transaction record for the restoration using correct enum value
  INSERT INTO zcred_transactions (
    user_id,
    type,
    amount,
