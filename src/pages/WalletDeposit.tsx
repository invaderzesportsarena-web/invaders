      ...
      <Card className="esports-card">
        <CardHeader>
          ...
          <CardDescription className="text-text-secondary">
            Fill in all details about your bank transfer
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="bank_sender_name"
                value={formData.bank_sender_name}
                onChange={(e) => handleInputChange('bank_sender_name', e.target.value)}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                value={formData.sender_account_no}
                onChange={(e) => handleInputChange('sender_account_no', e.target.value)}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                type="datetime-local"
                value={formData.transfer_timestamp}
                onChange={(e) => handleInputChange('transfer_timestamp', e.target.value)}
                className="rounded-2xl"
                required
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              {formData.screenshot_url && (
                <p className="text-sm text-success">✓ Screenshot uploaded successfully</p>
              )}
            </div>
            ...
            <div className="bg-secondary/50 rounded-2xl p-4">
              ...
              <ul className="text-sm text-text-secondary space-y-1">
                ...
                <li>• Exchange rate: 1 PKR = 1 Z-Credit (rounded up)</li>
