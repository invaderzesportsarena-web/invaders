...
export default function AdminTournaments() {
  ...
  const handleEdit = async (tournament: Tournament) => {
    ...
    setFormData({
      ...
      starts_at: tournament.starts_at ? formatInTimeZone(new Date(tournament.starts_at), 'Asia/Karachi', "yyyy-MM-dd'T'HH:mm") : "",
      reg_starts_at: tournament.reg_starts_at ? formatInTimeZone(new Date(tournament.reg_starts_at), 'Asia/Karachi', "yyyy-MM-dd'T'HH:mm") : "",
      reg_closes_at: tournament.reg_closes_at ? formatInTimeZone(new Date(tournament.reg_closes_at), 'Asia/Karachi', "yyyy-MM-dd'T'HH:mm") : "",
