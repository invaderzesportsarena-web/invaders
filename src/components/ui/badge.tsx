  ...
  "inline-flex items-center rounded-xl border px-3 py-1 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        outline: "text-foreground border-stroke",
        success: "border-transparent bg-success text-white",
        warning: "border-transparent bg-warning text-white",
        live: "border-transparent bg-danger text-white animate-pulse",
        esports: "border-transparent bg-gradient-accent text-white",
      },
    },
    defaultVariants: {
      variant: "default",
